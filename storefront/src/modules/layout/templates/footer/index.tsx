      ...
      <div className="content-container flex flex-col w-full">
        <div className="grid grid-cols-1 small:grid-cols-4 gap-8 py-16">
          ...
          <div className="flex flex-col gap-y-4">
            ...
            <Text className="text-sm text-gray-600 dark:text-gray-400 max-w-xs">
              {t("brandDescription")}
            </Text>
            <div className="flex gap-4 mt-2">
              ...
              <a href="#" className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors" aria-label="Instagram">
          ...
          <div className="flex flex-col gap-y-3">
            ...
            <div className="flex gap-2 mt-1">
              <input
                ...
                className="flex-1 px-3 py-2 text-sm border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-900 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
