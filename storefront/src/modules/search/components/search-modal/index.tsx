        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-start small:items-center small:justify-center small:p-4">
            <TransitionChild
              as={Fragment}
              enter="ease-out duration-200"
              enterFrom="opacity-0 translate-y-4 small:translate-y-0 small:scale-95"
              enterTo="opacity-100 translate-y-0 small:scale-100"
              leave="ease-in duration-150"
              leaveFrom="opacity-100 translate-y-0 small:scale-100"
              leaveTo="opacity-0 translate-y-4 small:translate-y-0 small:scale-95"
            >
              <DialogPanel className="w-full h-screen small:h-auto small:max-h-[80vh] small:max-w-2xl small:rounded-xl bg-white dark:bg-gray-900 shadow-xl flex flex-col overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto">
                  ...
                  {results.length > 0 && (
                    <div className="py-2">
                      <DialogTitle className="px-4 py-2 text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">
                        {t("searchResults")}
                      </DialogTitle>
                      <ul>
                        {results.map((product) => {
